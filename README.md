...
The crate ships thirteen criterion benches under `benches/`: the
...
`apply_subtract_green`); and the two encoder-side §3.7.2 per-pass
...
sparse frequency regimes. Numbers, profile findings, and the
